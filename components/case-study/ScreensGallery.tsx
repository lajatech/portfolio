...
const galleries: Record<string, GalleryImage[]> = {
  ...
  estility: [
    ...
    /* mobile app strip */
    {
      src: "/images/estility/IMG_5278.PNG",
      alt: "Estility app — onboarding splash",
      caption: "Onboarding",
      sub: "Single screen, single promise. Get Started.",
      aspect: "9/19",
      mobile: true,
    },
    {
      src: "/images/estility/IMG_5279.PNG",
      alt: "Estility app — sign in screen",
      caption: "Sign in",
      aspect: "9/19",
      mobile: true,
    },
    {
      src: "/images/estility/IMG_5281.PNG",
      alt: "Estility app — home dashboard with fuel and gas CTAs",
      caption: "Home",
      sub: "Fuel stations and gas vendors surfaced by proximity.",
      aspect: "9/19",
      mobile: true,
    },
    {
      src: "/images/estility/IMG_5280.PNG",
      alt: "Estility app — home with referral modal",
      caption: "Referrals",
      sub: "Earn money when friends order on Estility.",
      aspect: "9/19",
      mobile: true,
    },
    {
      src: "/images/estility/IMG_5283.PNG",
      alt: "Estility app — gas purchase vendor listing",
      caption: "Buy Gas",
      sub: "Nearby vendors ranked by distance, open status, and rating.",
      aspect: "9/19",
      mobile: true,
    },
    {
      src: "/images/estility/IMG_5282.PNG",
      alt: "Estility app — wallet transactions",
      caption: "Wallet",
      sub: "Full transaction history, searchable and filterable.",
      aspect: "9/19",
      mobile: true,
    },
    /* detail grid */
