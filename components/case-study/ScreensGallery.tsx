...
const galleries: Record<string, GalleryImage[]> = {
  ...
  estility: [
    ...
    {
      src: "/images/estility/web-02-screens.png",
      alt: "Estility web platform screens",
      caption: "Web platform",
      sub: "Resident portals, operational dashboards, analytics — all within one consistent design language.",
      wide: true,
      aspect: "16/9",
    },
    {
    ...
    },
    {
      ...
      alt: "Estility mobile app — screen Y",
      caption: "App · Services",
      aspect: "9/19",
      mobile: true,
    },
    {
      src: "/images/estility/05-app-x.webp",
      alt: "Estility mobile app — screen X",
      caption: "App · Community",
      aspect: "9/19",
      mobile: true,
    },
    {
      src: "/images/estility/06-app-w.webp",
      alt: "Estility mobile app — screen W",
      caption: "App · Profile",
      aspect: "9/19",
      mobile: true,
    },
